...
class SendsAllHomework extends StatefulWidget {
  SendsAllHomework({super.key});

  @override
  State<SendsAllHomework> createState() => _SendAllHomework();
}

class _SendAllHomework extends State<SendsAllHomework> {
