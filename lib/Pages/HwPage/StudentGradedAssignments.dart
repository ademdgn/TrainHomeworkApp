...
import 'HwTeacherCard.dart';

class StudentGradeHomework extends StatefulWidget {
  StudentGradeHomework({super.key});

  @override
  State<StudentGradeHomework> createState() => _StudentGradeHomework();
}

class _StudentGradeHomework extends State<StudentGradeHomework> {
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    SendsPageTitle(fem: fem, ffem: ffem, name: 'Students Sent'),
                    const SizedBox(
                      height: 20,
                    ),
                    StreamBuilder<List<Map<String, dynamic>>>(
                        stream: hwController.SendsAllHomeworkStream(),
